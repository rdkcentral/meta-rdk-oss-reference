...
#FILESEXTRAPATHS_prepend := "/home/dave/code/local/gperftools:"
#SRC_URI = "file://gperftools-2.6.tar.gz"

SRC_URI_append_arm = " file://stacktrace_arm.patch "
SRC_URI_append = " file://001-run-heap-checker-after-fork.patch "

STACKTRACE_METHOD_arm = "arm"
...
FULL_OPTIMIZATION_remove = "${@bb.utils.contains('DISTRO_FEATURES_RDK', 'comcast-gperftools-heapcheck-wp', '-Og', '', d)}"
...
FILES_${PN} += "${bindir}/env ${bindir}/addr2line ${bindir}/objdump ${bindir}/nm ${bindir}/c++filt ${SCR_FILE_TARGET}"

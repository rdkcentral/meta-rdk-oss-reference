...
DEPENDS = "openssl libev zlib c-ares libxml2 systemd jansson"
...
FILES:${PN}-client = "${bindir}/nghttp"
FILES:${PN}-proxy  = "${bindir}/nghttpx"
FILES:${PN}-common = "${bindir}/h2load ${libdir}/libnghttp2.so.14.16.1 ${datadir}/nghttp2/fetch-ocsp-response"

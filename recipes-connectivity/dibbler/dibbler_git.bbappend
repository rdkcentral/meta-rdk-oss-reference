...
CFLAGS:append:wrynose = " -Wno-error=return-mismatch"
CXXFLAGS:append:wrynose = " -Wno-error=return-mismatch"
...
SRC_URI:append:broadband = " ${@bb.utils.contains('DISTRO_FEATURES', 'em_extender', ' ',' file://Configurable-WanName-NotifyScript-mapT.patch', d)}"

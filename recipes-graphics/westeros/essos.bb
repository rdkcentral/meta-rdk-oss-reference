...
CXXFLAGS:append = "${@bb.utils.contains('DISTRO_FEATURES', 'erm_unauthorized_requests_abort', ' -DUNAUTHORIZED_REQUESTS_ABORT', '', d)}"
CXXFLAGS:append = "${@bb.utils.contains('DISTRO_FEATURES', 'flex2_rdk', ' -DUNAUTHORIZED_REQUESTS_ABORT', '', d)}"

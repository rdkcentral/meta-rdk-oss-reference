...
SESHAT_CMAKE_POLICY = ""
SESHAT_CMAKE_POLICY:wrynose = "-DCMAKE_POLICY_VERSION_MINIMUM=3.5"

do_compile() {
    rm -rf ${S}/build
    mkdir ${S}/build
    cd ${S}/build
    cmake -DCMAKE_SKIP_BUILD_RPATH=true -DBUILD_TESTING=OFF -DBUILD_YOCTO=true ${SESHAT_CMAKE_POLICY} ..

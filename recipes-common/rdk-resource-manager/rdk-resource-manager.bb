...
SYSLOG-NG_FILTER = "rdk-resource-manager"
SYSLOG-NG_SERVICE_rdk-resource-manager = "gen-rmgr.service"
SYSLOG-NG_DESTINATION_rdk-resource-manager = "rdkrm.log"
SYSLOG-NG_LOGRATE_rdk-resource-manager = "high"

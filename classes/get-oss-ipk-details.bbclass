...
do_get_ipk_details () {
  ...
  do
	...
	echo "PV_pn-$component = \"$recipe_pv\"" >> $OUTPUT_FILE_NAME
	echo "PR_pn-$component = \"$recipe_pr\"" >> $OUTPUT_FILE_NAME
	echo "PACKAGE_ARCH_pn-$component = \"\${OSS_LAYER_EXTENSION}\"" >> $OUTPUT_FILE_NAME
	echo "IPK_PACKAGES_pn-$component = \""$ipks_list"\"" >> $OUTPUT_FILE_NAME
	echo "IPK_CHECKSUM_pn-$component = \""$ipk_checksum"\"" >> $OUTPUT_FILE_NAME
	echo "IPK_SRC_BUILD_pn-$component = \"true\"" >> $OUTPUT_FILE_NAME
	echo "" >> $OUTPUT_FILE_NAME
  done
}

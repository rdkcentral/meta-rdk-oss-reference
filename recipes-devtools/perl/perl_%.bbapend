ALTERNATIVE_${PN}-misc_remove = " corelist cpan enc2xs encguess h2ph h2xs instmodsh json_pp libnetcfg \
...
FILES_${PN}_remove = " ${bindir}/perl ${bindir}/pcorelist ${bindir}/pcpan ${bindir}/enc2xs ${bindir}/encguess ${bindir}/h2ph ${bindir}/h2xs ${bindir}/instmodsh ${bindir}/json_pp ${bindir}/libnetcfg \
...
PACKAGE_PREPROCESS_FUNCS_remove = " perl_package_preprocess"
PACKAGE_PREPROCESS_FUNCS_append = " perl_package_preprocess_reduced"

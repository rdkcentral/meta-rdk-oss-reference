...
# Restore C11 semantics. GCC 15 also makes -Wimplicit-function-declaration an error
# even in gnu11 mode; suppress that too (bsd_signal implicit decl in main.c).

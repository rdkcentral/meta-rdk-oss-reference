...
LDFLAGS:prepend_libc-uclibc = " -lrt -lpthread "
...
# 140     KiB /armv4t/gettext-dev_0.14.1-r6:armv4t.ipk
...
FILES:gettext-runtime = "${bindir}/gettext \
                        ...
                        "
FILES:gettext-runtime:append:libc-uclibc = " ${libdir}/libintl.so.* \
...
FILES:gettext-runtime-dev:append:libc-uclibc = " ${libdir}/libintl.so \

SUMMARY = "This recipe compiles and builds aker."
SECTION = "libs"
...
SRC_URI = "git://github.com/xmidt-org/aker.git;branch=main;protocol=https;nobranch=1"
SRC_URI += "file://aker-01.patch"
# drop_root_aker.patch: already present in git source

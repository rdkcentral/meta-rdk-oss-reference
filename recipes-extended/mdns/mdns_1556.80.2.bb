...
SRC_URI = "git://github.com/apple-oss-distributions/mDNSResponder;protocol=https;branch=rel/mDNSResponder-1556 \
           file://0006-make-Add-top-level-Makefile.patch \
           file://0001-Add-WOLAN-functionality.patch \
           file://0004-make-Separate-TLS-targets-from-lib.patch \
           file://0002-make-Set-libdns_sd.so-soname.patch \
           file://RDKTV-27328-dns-sd-discovery-shows-the-same-local-hostname-when-2-devices-on-same-network.patch \
           file://RDKTV-28175-Configure-sleepproxy-timer-to-24-hours.patch \
           file://RDKTV-31457-mdns-root-previlege.patch \
           file://RDKTV-31457-dobby0-rec-deregister-fix.patch \
           file://mdns.service \
           "
SRCREV = "b9fbcaf55332bfd3165e59c40718645cef14e5cf"
...
PACKAGECONFIG ?= "tls lpmlistener \
		  ${@bb.utils.filter('DISTRO_FEATURES', 'ipv6', d)}"
PACKAGECONFIG[debug] = "DEBUG=1,DEBUG=0"
PACKAGECONFIG[ipv6] = "HAVE_IPV6=1,HAVE_IPV6=0"
PACKAGECONFIG[lpmlistener] = "HAVE_LPM_LISTENER=1,HAVE_LPM_LISTENER=0"
PACKAGECONFIG ?= "tls \
		  ${@bb.utils.filter('DISTRO_FEATURES', 'ipv6', d)}"
PACKAGECONFIG[debug] = "DEBUG=1,DEBUG=0"
PACKAGECONFIG[ipv6] = "HAVE_IPV6=1,HAVE_IPV6=0"

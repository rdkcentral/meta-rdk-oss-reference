...
SRC_URI = "https://download.gnome.org/sources/libmanette/0.2/libmanette-${PV}.tar.xz \
           file://0.2/0001-old-kernel-and-64-bit-kernel-build-error-fix.patch \
           file://0.2/0001-send-event-in-thread-context.patch \
           file://0.2/0001-default-gamepad-db-dir-usr-share.patch \
           file://gamecontrollerdb \
           file://0.2/0001-new-SDL-gamedb.patch \
           file://0.2/0002-add-wayland-inputfd-support.patch \
           file://0.2/0001-map-key-menu-back-as-btn.patch \
           file://0.2/0003-button-values-for-gas-brake.patch \
           file://0.2/0001-nintendo-digital-trigger-dpad-fix.patch \
           file://0.2/0001-nintendo-joycon-L-R-detect.patch \
           file://0.2/0004-handle-revoked-evdev-devices.patch \
           file://0.2/0004-exclusive-grab-and-reconnect.patch \
           "
SRC_URI += "file://99-gamepad-set-attr.rules"
